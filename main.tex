...
\todo[inline]{iñaki: Ados egingo dut. Hemen agian idatzi behar dira gauza orokorrak : entrenamendu plataformak, gpu ezaguarriak? ingenieritzako gauzak}
...
- 5 run average in all evaluations. 

- flair used for training and evaluating static and flair embeddings.

- Bert finetuning used for training all bert models presented.

- experiments done using GTX1080 and XXXX gpus 
...
fastext-common-crawl & 28.82 & 3.73  \\
fastext-BMC  & 69.45 & 60.14 \\
\hline%\hline
\textbf{FlairEmbeddings}\\
Flair-official & 56.83 & 50.88 \\
Flair-BMC  & 62.42	& 54.24  \\
Pooled Flair-BMC  & 68.53 & 60.57  \\
%\hline
...
\hline 
\multicolumn{3}{@{}l}{\scriptsize{\textb{Previous state-of-the-art}}} \\
\hline
